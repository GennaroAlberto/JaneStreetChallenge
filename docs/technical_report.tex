...
\subsection{Selective state space (\texttt{mamba})}
A pure-PyTorch Mamba block --- data-dependent linear dynamics with an unbounded
latent, a third architectural family distinct from gated RNNs and attention.
Included primarily as a source of ensemble diversity.
